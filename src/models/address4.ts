...
export interface Address4 {
  /** Type of the address. This is a code. You can find the possible values at [Address types](#tag/Reference-codes/Address-types) */
  addressType: string;
  /** Area of the address */
  area?: string;
  ...
  name?: string;
  /** Region of the address. Mandatory for Non EU destinations where a region is applicable. */
  region?: string;
...
export const address4Schema: Schema<Address4> = object({
